          ...
          sx={{
            ...
            [muiTheme.breakpoints.down("sm")]: {
              background: (theme) =>
                `linear-gradient(to top, ${
                  isDarkMode
                    ? "rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.75) 30%, rgba(0,0,0,0.2)"
                    : "rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.7) 35%, rgba(0,0,0,0.1)"
                } 100%)`,
              paddingBottom: 2.5,
            },
          }}
                ...
                <Button
                  ...
                  sx={{
                    ...
                    [muiTheme.breakpoints.down("sm")]: {
                      ...
                      py: 0.8,
                      fontSize: "0.9rem",
                      bgcolor: alpha(getCategoryColor(place.category), 0.2),
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      height: "100%", // Ensure full height to allow mt:auto to work
                    }}
                  >
                    <Box
                      sx={{
